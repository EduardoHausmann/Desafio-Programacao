...
INSERT INTO pessoas (nome, sobrenome, cpf, endereco, telefone, email, data_nascimento, nome_mae, sexo, registro_ativo) OUTPUT INSERTED.ID VALUES ('ROBERT',' STOLL STEINHEUSER','102.777.399-59','NICOLAU LINK, LADO 298 CX 01','(47)9922-3562','robert@proway.com','2002-12-20','PAULA STEINHEUSER','Masculino',1);
...
INSERT INTO pessoas (nome, sobrenome, cpf, endereco, telefone, email, data_nascimento, nome_mae, sexo, registro_ativo) OUTPUT INSERTED.ID VALUES ('ROSIMEIRE',' CRISTINA BIAZUS','557.933.489-34','CAMPOS NOVOS - 269','(47)9921-2650','roseimeire@proway.com','2002-03-17','JULIA CRISTINA BIAZUS','Feminino',1);
...
INSERT INTO pessoas (nome, sobrenome, cpf, endereco, telefone, email, data_nascimento, nome_mae, sexo, registro_ativo) OUTPUT INSERTED.ID VALUES ('RONALDO',' DA SILVA TAVEIRA','415.667.977-49','ROBERTO BRUCH, LD27 AP07','(47)9924-5837','ronaldo@proway.com','2001-10-27','RONALDINA DA SILVA TAVEIRA','Masculino',1);
...
INSERT INTO pessoas (nome, sobrenome, cpf, endereco, telefone, email, data_nascimento, nome_mae, sexo, registro_ativo) OUTPUT INSERTED.ID VALUES ('PEDRO',' DE BORBA','381.003.339-53','RUA BELO HORIZONTE, 739','(47)9923-2519','borba@proway.com','2003-01-25',	'PEDROSA BORBALETA','Masculino',1);
INSERT INTO pessoas (nome, sobrenome, cpf, endereco, telefone, email, data_nascimento, nome_mae, sexo, registro_ativo) OUTPUT INSERTED.ID VALUES ('ROBERTO',' RODRIGUES DOS SANTOS','939.088.737-20','LORENCO MAFRA 100','(47)9923-2656','rodrigues@proway.com','2001-03-01','ROBERTA DOS SANTOS','Masculino',1);
INSERT INTO pessoas (nome, sobrenome, cpf, endereco, telefone, email, data_nascimento, nome_mae, sexo, registro_ativo) OUTPUT INSERTED.ID VALUES ('SIRLEI',' APARECIDA SILVA','906.007.369-68','ARGENTINA  313','(47)9921-2431','seilei@proway.com','2002-02-03','SIRLEI JOAQUINA SILVA','Feminino',1);
...
INSERT INTO pessoas (nome, sobrenome, cpf, endereco, telefone, email, data_nascimento, nome_mae, sexo, registro_ativo) OUTPUT INSERTED.ID VALUES ('PATRICIA',' PEREIRA SIMOES','008.506.807-98','JOAQUIM NABUCO,189','(47)9928-2300','patricia@proway.com','2001-05-09','KATIA  SIMOES','Feminino',1);
...
INSERT INTO pessoas (nome, sobrenome, cpf, endereco, telefone, email, data_nascimento, nome_mae, sexo, registro_ativo) OUTPUT INSERTED.ID VALUES ('SILVANA',' CARL','988.095.109-20','ARNOLDO CARL, 61 CX03','(47)9921-1940','silvana@proway.com','2003-10-19','SILVIA CAROLINA','Feminino',1);
