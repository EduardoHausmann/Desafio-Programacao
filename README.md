...
***Consulta de Sala de Evento***
   ...
   A tela possui um compo de texto para que possa ser feita a pesquisa a partir do nome da Sala de Evento; a tabela com todos os registro se atualiza automaticamente
conforme o campo de busca é preenchido, caso ao se pesquisar seja deixado o campo com " " o programa não realiza a busca. Ao se deixar o campo de busca vazio 
a tabela mostra o registro de todas as salas cadastradas no banco que estiverem ativas.
